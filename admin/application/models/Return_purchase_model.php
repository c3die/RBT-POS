...
class return_purchase_model extends CI_Model {
	...
	function __construct(){
		...
		$this->select_default = '*, purchase_retur.id AS id, sales_return_id,total_price, total_item,purchase_retur.date AS date,return_by';
	}
	...
	public function get_detail($retur_id){
		$sql = "SELECT *, purchase_retur.id AS id, product.id as product_id FROM purchase_retur 
				...
				WHERE purchase_retur.sales_return_id = '".$retur_id."'";
	...
	public function get_detail_by_sales_id($id){
		$sql = "SELECT *, purchase_retur.id AS id, product.id as product_id FROM purchase_retur 
					JOIN sales_data ON purchase_retur.sales_return_id = sales_data.sales_id 
