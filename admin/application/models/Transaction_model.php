...
$this->table = "purchase_transaction";
	...
	public function supp_detail($id,$array = false)
	{
		$this->db->select('*,purchase_transaction.id AS id,supplier.company_name AS company_name,product.product_name AS product_name,product.product_desc AS product_desc');
		$this->db->from('supplier');
		$this->db->join('purchase_transaction ',' supplier.id = purchase_transaction.supplier_id','right');
		$this->db->join('purchase_data',' purchase_transaction.id = purchase_data.transaction_id','left');
		$this->db->join('product',' purchase_data.product_id = product.id','left');
