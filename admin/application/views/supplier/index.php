        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Suppliers Data Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo site_url('supplier?search=true');?>" method="GET">
                ...
                <div class="box-body pad">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="submit">&nbsp</label>
                      <a href="<?php echo site_url('supplier/export_csv').get_uri();?>" class="form-control btn btn-info"><i class="fa fa-file-csv"></i> Export Excel</a>
                    </div>
                  </div>
                </div>
              </form>
            ...
            <td><?php echo $supplier->email;?></td>
					  ...
					  <td>
            <a  href="<?php echo site_url('supplier/detail').'/'.$supplier->id;?>" class="btn btn-xs bg-green">detail</a>
						<a href="<?php echo site_url('supplier/edit').'/'.$supplier->id;?>" class="btn btn-xs btn-primary">Edit</a>
						<a  href="<?php echo site_url('supplier/cancel').'/'.$supplier->id;?>" class="btn btn-xs btn-danger">Remove</a>
