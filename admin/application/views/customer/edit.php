              ...
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($customer) ? $customer['store_name'] : '';?>" name="store_name" placeholder="Enter Name Of Store" id="store_name" class="form-control" required/>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="status" value="" id="status" class="form-control"/>
                      ...
                      <input type="hidden" value="edit customer" name="activity"  id="activity" class="form-control"/>
