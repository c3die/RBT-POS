      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('return_sales/create');?>">Add Sales Returns</a></li>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo site_url('return_sales/create?search=true');?>" method="GET">
                ...
                <?php if(isset($sales) && is_array($sales)){ ?>
                  <?php foreach($sales as $sales){?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('return_sales/create_return').'/'.$sales->id;?>" class="btn btn-xs btn-info">Return</a>
                      </td>
                    </tr>
                  <?php } ?>
                <?php } ?>
