                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo !empty($product) ? $product['id'] : $code_product;?>" id="kode" class="form-control" disabled/>
                      ...
                      <input type="hidden" name="status" value="" id="status" class="form-control"/>
                       ...
                       <input type="hidden" value="add new Product" name="activity"  id="activity" class="form-control"/>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number"  onkeypress="return isNumeric(event)"  oninput="maxLengthCheck(this)" value="<?php echo !empty($product) ? $product['reorder_level'] : '0';?>" name="reorder_level" placeholder="Quantity" id="reorder_level" min="0" max="999" class="form-control"/>
                      ...
                      <input type="hidden"  onkeypress="return isNumeric(event)"  oninput="maxLengthCheck(this)" value="<?php echo !empty($product) ? $product['product_qty'] : '0';?>" name="product_qty" placeholder="Quantity" id="qty" min="0" max="999" class="form-control"/>
                    
                 
                    <!-- selling price-->
                      <input type="hidden" onkeypress="return isNumeric(event)"  oninput="maxLengthCheck(this)" min="1" max="9999" value="<?php echo !empty($product) ? $product['sale_price'] : '0';?>" name="sale_price" placeholder="Product Sale" id="sale" class="form-control"/>
