                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('return_purchase');?>" class="btn btn-sm btn-danger">Back</a></span>
								<?php if($details[0]->is_return == 0){?>
                                <span><a href="<?php echo site_url('return_purchase/edit');?>/<?php echo $details[0]->id;?>" class="btn btn-sm btn-success">Edit</a></span>								
								<?php } ?>
                            </div>
                        </div>
                        <!-- /.box-header -->
